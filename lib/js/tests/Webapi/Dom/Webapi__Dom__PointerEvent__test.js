...
let Webapi__Dom__PointerEvent = require("../../../src/Webapi/Dom/Webapi__Dom__PointerEvent.js");
...
let eventPhase = Webapi__Dom__PointerEvent.eventPhase(event);
...
let getModifierState = Webapi__Dom__PointerEvent.getModifierState(event, "Alt");
...
let pointerType = Webapi__Dom__PointerEvent.pointerType(event);
