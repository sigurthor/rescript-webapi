...
let elm = document.createElement("strong");
...
let htmlElm = TestHelpers.unsafelyUnwrapOption(Webapi__Dom__HtmlElement.ofElement(document.createElement("strong")));
...
let htmlDoc = TestHelpers.unsafelyUnwrapOption(Webapi__Dom__Document.asHtmlDocument(document));
