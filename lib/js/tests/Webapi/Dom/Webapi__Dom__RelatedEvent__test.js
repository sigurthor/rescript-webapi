...
let Webapi__Dom__RelatedEvent = require("../../../src/Webapi/Dom/Webapi__Dom__RelatedEvent.js");

let event = new RelatedEvent("my-event");
...
let eventPhase = Webapi__Dom__RelatedEvent.eventPhase(event);
