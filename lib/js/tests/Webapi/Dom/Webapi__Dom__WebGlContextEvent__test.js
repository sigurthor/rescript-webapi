...
let Webapi__Dom__WebGlContextEvent = require("../../../src/Webapi/Dom/Webapi__Dom__WebGlContextEvent.js");

let event = new WebGLContextEvent("my-event");
...
let eventPhase = Webapi__Dom__WebGlContextEvent.eventPhase(event);
