...
let Webapi__Dom__PopStateEvent = require("../../../src/Webapi/Dom/Webapi__Dom__PopStateEvent.js");

let event = new PopStateEvent("my-event");
...
let eventPhase = Webapi__Dom__PopStateEvent.eventPhase(event);
