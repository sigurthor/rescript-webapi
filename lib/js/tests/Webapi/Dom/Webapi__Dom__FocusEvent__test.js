...
let Webapi__Dom__FocusEvent = require("../../../src/Webapi/Dom/Webapi__Dom__FocusEvent.js");

let event = new FocusEvent("my-event");
...
let eventPhase = Webapi__Dom__FocusEvent.eventPhase(event);
