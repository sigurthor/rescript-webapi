...
let Webapi__Dom__ProgressEvent = require("../../../src/Webapi/Dom/Webapi__Dom__ProgressEvent.js");

let event = new ProgressEvent("my-event");
...
let eventPhase = Webapi__Dom__ProgressEvent.eventPhase(event);
