...
let Webapi__Dom__TrackEvent = require("../../../src/Webapi/Dom/Webapi__Dom__TrackEvent.js");

let event = new TrackEvent("my-event");
...
let eventPhase = Webapi__Dom__TrackEvent.eventPhase(event);
