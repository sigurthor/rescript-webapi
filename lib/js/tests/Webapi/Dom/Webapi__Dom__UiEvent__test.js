...
let Webapi__Dom__UiEvent = require("../../../src/Webapi/Dom/Webapi__Dom__UiEvent.js");

let event = new UIEvent("my-event");
...
let eventPhase = Webapi__Dom__UiEvent.eventPhase(event);
