...
let Webapi__Dom__ClipboardEvent = require("../../../src/Webapi/Dom/Webapi__Dom__ClipboardEvent.js");

let event = new ClipboardEvent("my-event");
...
let eventPhase = Webapi__Dom__ClipboardEvent.eventPhase(event);
