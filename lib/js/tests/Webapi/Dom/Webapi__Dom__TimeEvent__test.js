...
let Webapi__Dom__TimeEvent = require("../../../src/Webapi/Dom/Webapi__Dom__TimeEvent.js");

let event = new TimeEvent("my-event");
...
let eventPhase = Webapi__Dom__TimeEvent.eventPhase(event);
