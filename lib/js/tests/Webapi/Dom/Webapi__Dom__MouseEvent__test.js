...
let Webapi__Dom__MouseEvent = require("../../../src/Webapi/Dom/Webapi__Dom__MouseEvent.js");

let event = new MouseEvent("my-event");
...
let eventPhase = Webapi__Dom__MouseEvent.eventPhase(event);
...
let getModifierState = Webapi__Dom__MouseEvent.getModifierState(event, "Alt");
