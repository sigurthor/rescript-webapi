...
let Webapi__Dom__TransitionEvent = require("../../../src/Webapi/Dom/Webapi__Dom__TransitionEvent.js");

let event = new TransitionEvent("my-event");
...
let eventPhase = Webapi__Dom__TransitionEvent.eventPhase(event);
