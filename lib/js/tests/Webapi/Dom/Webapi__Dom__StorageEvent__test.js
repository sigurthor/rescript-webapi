...
let Webapi__Dom__StorageEvent = require("../../../src/Webapi/Dom/Webapi__Dom__StorageEvent.js");

let event = new StorageEvent("my-event");
...
let eventPhase = Webapi__Dom__StorageEvent.eventPhase(event);
